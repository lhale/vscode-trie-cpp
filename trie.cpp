/*
 * Ref: https://gist.github.com/calmhandtitan/7872405
 */
...
// kaboom == true will cause a segmentation fault in this function for word
void insert(string word, bool kaboom=false)
{
	node *current = head;
...
int main()
{
	...
	s = "abhishek";
	insert(s);
	s = "kaboom";   // 'k' has not been trie'd yet
	insert(s, true);
